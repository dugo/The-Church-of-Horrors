...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfileItem.icon'
        db.add_column('userprofile_userprofileitem', 'icon',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfileItem.icon'
        db.delete_column('userprofile_userprofileitem', 'icon')
