...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Number'
        db.create_table('blog_number', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('number', self.gf('django.db.models.fields.PositiveIntegerField')(unique=True, db_index=True)),
            ('month', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('year', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('blog', ['Number'])

        # Deleting field 'Entry.section'
        db.delete_column('blog_entry', 'section_id')

        # Adding field 'Entry.number'
        db.add_column('blog_entry', 'number', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['blog.Number'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('blog_section', (
            ('slug', self.gf('django.db.models.fields.SlugField')(blank=True, max_length=255, unique=True, db_index=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.delete_table('blog_number')

        # Adding field 'Entry.section'
        db.add_column('blog_entry', 'section', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['blog.Section']), keep_default=False)

        # Deleting field 'Entry.number'
        db.delete_column('blog_entry', 'number_id')
    ...
    models = {
        ...
        'blog.entry': {
            ...
            'number': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['blog.Number']", 'null': 'True'}),
