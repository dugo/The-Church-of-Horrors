...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entry.is_editorial'
        db.add_column('blog_entry', 'is_editorial', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Entry.is_editorial'
        db.delete_column('blog_entry', 'is_editorial')
