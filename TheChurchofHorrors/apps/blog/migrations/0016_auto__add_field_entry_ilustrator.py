...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.ilustrator'
        db.add_column('blog_entry', 'ilustrator',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='ilustrations', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.ilustrator'
        db.delete_column('blog_entry', 'ilustrator_id')
    ...
    models = {
        ...
        'blog.entry': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ilustrator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ilustrations'", 'null': 'True', 'to': "orm['auth.User']"}),
            ...
            'shared': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'db_index': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '255', 'blank': 'True'}),
            'subsection': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'entries'", 'to': "orm['blog.Subsection']"}),
