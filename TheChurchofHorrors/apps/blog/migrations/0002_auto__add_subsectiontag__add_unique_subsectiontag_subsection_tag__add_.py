...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SubsectionTag'
        db.create_table('blog_subsectiontag', (
        ...
        db.send_create_signal('blog', ['SubsectionTag'])

        # Adding unique constraint on 'SubsectionTag', fields ['subsection', 'tag']
        db.create_unique('blog_subsectiontag', ['subsection_id', 'tag_id'])

        # Adding unique constraint on 'SubsectionTag', fields ['sort', 'subsection']
        db.create_unique('blog_subsectiontag', ['sort', 'subsection_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SubsectionTag', fields ['sort', 'subsection']
        db.delete_unique('blog_subsectiontag', ['sort', 'subsection_id'])

        # Removing unique constraint on 'SubsectionTag', fields ['subsection', 'tag']
        db.delete_unique('blog_subsectiontag', ['subsection_id', 'tag_id'])

        # Deleting model 'SubsectionTag'
        db.delete_table('blog_subsectiontag')
