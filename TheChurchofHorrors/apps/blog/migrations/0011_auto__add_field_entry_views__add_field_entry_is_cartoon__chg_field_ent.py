...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('blog_entry', 'views',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Entry.is_cartoon'
        db.add_column('blog_entry', 'is_cartoon',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Entry.imagen'
        db.alter_column('blog_entry', 'imagen', self.gf('filebrowser.fields.FileBrowseField')())

        # Changing field 'Number.imagen'
        db.alter_column('blog_number', 'imagen', self.gf('filebrowser.fields.FileBrowseField')())

    def backwards(self, orm):
        # Deleting field 'Entry.views'
        db.delete_column('blog_entry', 'views')

        # Deleting field 'Entry.is_cartoon'
        db.delete_column('blog_entry', 'is_cartoon')


        # Changing field 'Entry.imagen'
        db.alter_column('blog_entry', 'imagen', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'Number.imagen'
        db.alter_column('blog_number', 'imagen', self.gf('django.db.models.fields.files.FileField')(max_length=100))
