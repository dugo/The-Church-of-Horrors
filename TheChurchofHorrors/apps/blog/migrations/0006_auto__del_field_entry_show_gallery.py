...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Entry.show_gallery'
        db.delete_column('blog_entry', 'show_gallery')


    def backwards(self, orm):
        
        # Adding field 'Entry.show_gallery'
        db.add_column('blog_entry', 'show_gallery', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    models = {
        ...
        'blog.entry': {
            ...
            'number': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['blog.Number']", 'null': 'True', 'blank': 'True'}),
