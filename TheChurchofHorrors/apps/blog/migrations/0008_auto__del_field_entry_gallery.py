...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Entry.gallery'
        db.delete_column('blog_entry', 'gallery')


    def backwards(self, orm):
        
        # Adding field 'Entry.gallery'
        db.add_column('blog_entry', 'gallery', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
