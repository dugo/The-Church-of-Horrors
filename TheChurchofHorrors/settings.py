...
STATIC_URL = 'http://static.thechurchofhorrors.com/'
#STATIC_URL = '/static/'
...
TINYMCE_DEFAULT_CONFIG = {
    ...
    "theme_advanced_font_sizes" : "10px,11px,12px,13px,14px,15px,16px",
